 ...
 * @property {string} [primary_position_canonical]
 * @property {string[]} [secondary_positions_canonical]
 * @property {string} [primary_position_group]
 * @property {string[]} [secondary_position_groups]
